...
$rom=mysql_fetch_array($rs);
	...
	$query= "SELECT sename FROM op WHERE username='{$name}'";
	...
	$sename= $arr[0]["sename"];	
//需全路径
$curr_file = "./{$sename}/hello.txt"; //默认编辑当前文件
...
if ( isset($_GET['logout']) ) {
		header("Location: http://localhost/ace/UCON/index.php");
