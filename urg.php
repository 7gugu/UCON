		...
		<div class="container">
			...
			<div class="row">
				...
				<ul class="left-form">
					<h2>更改参数</h2>
					<li>
						<input type="text" class="span3" id="sename" name="sename" placeholder="servername" />	
						<div class="clear"> </div>
					</li> 
					<li>
					...
					<li>
						<input type="text" class="span3"  id="map" name="map" placeholder="map" />	
						<div class="clear"> </div>
					</li> 
					<li>
						<input type="text" class="span3" id="port" name="sport" placeholder="port" />	
						<div class="clear"> </div>
					</li>  
					<li>
						<input type="text" class="span3" id="Perspective" name="Perspective"  placeholder="Perspective" />
						<div class="clear"> </div>
					<li>
						<input type="text" class="span3" id="mode" name="mode"  placeholder="Mode" />
						<div class="clear"> </div>
					</li> 
					<li>
						<input type="text" class="span3" id="welcome" name="welcome"  placeholder="Welcome" />
						<div class="clear"> </div>
					</li> 
